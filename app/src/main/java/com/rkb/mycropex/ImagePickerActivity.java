    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (resultCode == Activity.RESULT_OK) {
            if(requestCode == REQUEST_PICK_IMAGE) {
                ...
                intent.putExtra(CropImage.EXTRA_IMAGE_URI, imageUri.toString());
                startActivityForResult(intent, REQUEST_CROP_IMAGE);
            }
            else if(requestCode == REQUEST_CROP_IMAGE) {
                System.out.println("Image crop success :"+data.getStringExtra(CropImage.CROPPED_IMAGE_PATH));
                String imagePath = new File(data.getStringExtra(CropImage.CROPPED_IMAGE_PATH), "image.jpg").getAbsolutePath();
